...
exports.coinTransaction = async (req, res, next) => {
  try {
...
exports.getCoinIncome = async (req, res, next) => {
  try {
    if (!req.query.user_id) {
      return res
        .status(200)
...
exports.getCoinOutCome = async (req, res, next) => {
  try {
    if (!req.query.user_id) {
      return res
        .status(200)
...
//for admin
exports.purchaseCoinHistory = async (req, res, next) => {
  try {
