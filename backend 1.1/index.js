...
// const io_ = require("socket.io")(server);
...
// var checkAccessWithSecretKey = require("./checkAccess");s
// app.use(checkAccessWithSecretKey());
...
//temp live User
// const { destroyAll } = require("./server/tempLiveUser/tempLiveUser.controller");
const TempLiveUserRoute = require("./server/tempLiveUser/tempLiveUser.route");
app.use("/templiveuser", TempLiveUserRoute);
